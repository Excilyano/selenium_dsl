...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Show Multiple</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.imta.tp.selenium.selenium.impl.ShowMultipleImpl#getElem <em>Elem</em>}</li>
 *   <li>{@link fr.imta.tp.selenium.selenium.impl.ShowMultipleImpl#getArrayAccess <em>Array Access</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ShowMultipleImpl extends CallNativeImpl implements ShowMultiple
{
  /**
  ...
  {
    return SeleniumPackage.Literals.SHOW_MULTIPLE;
  }
    ...
    if (elem != null && elem.eIsProxy())
    {
      ...
      if (elem != oldElem)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SeleniumPackage.SHOW_MULTIPLE__ELEM, oldElem, elem));
      }
    }
    return elem;
  }
  ...
  public void setElem(SeleniumType newElem)
  {
    ...
    elem = newElem;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeleniumPackage.SHOW_MULTIPLE__ELEM, oldElem, elem));
  }
  ...
  public NotificationChain basicSetArrayAccess(ArrayAccess newArrayAccess, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SeleniumPackage.SHOW_MULTIPLE__ARRAY_ACCESS, oldArrayAccess, newArrayAccess);
  ...
  public void setArrayAccess(ArrayAccess newArrayAccess)
  {
    if (newArrayAccess != arrayAccess)
    {
      ...
      if (arrayAccess != null)
        msgs = ((InternalEObject)arrayAccess).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SeleniumPackage.SHOW_MULTIPLE__ARRAY_ACCESS, null, msgs);
      if (newArrayAccess != null)
        msgs = ((InternalEObject)newArrayAccess).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SeleniumPackage.SHOW_MULTIPLE__ARRAY_ACCESS, null, msgs);
      msgs = basicSetArrayAccess(newArrayAccess, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeleniumPackage.SHOW_MULTIPLE__ARRAY_ACCESS, newArrayAccess, newArrayAccess));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SeleniumPackage.SHOW_MULTIPLE__ARRAY_ACCESS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SeleniumPackage.SHOW_MULTIPLE__ELEM:
