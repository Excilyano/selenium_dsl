 ...
 * <ul>
 *   <li>{@link fr.imta.tp.selenium.selenium.impl.OpenImpl#getBrowser <em>Browser</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OpenImpl extends CallNativeImpl implements Open
{
  /**
  ...
  {
    return SeleniumPackage.Literals.OPEN;
  }
  ...
  public void setBrowser(BROWSER newBrowser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SeleniumPackage.OPEN__BROWSER, oldBrowser, browser));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SeleniumPackage.OPEN__BROWSER:
        return getBrowser();
    }
