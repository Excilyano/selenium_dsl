 ...
 * <ul>
 *   <li>{@link fr.imta.tp.selenium.selenium.Close#getBrowser <em>Browser</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.imta.tp.selenium.selenium.SeleniumPackage#getClose()
 * @model
 * @generated
 */
public interface Close extends CallNative
{
  /**
   ...
   * @see fr.imta.tp.selenium.selenium.SeleniumPackage#getClose_Browser()
   * @model
   * @generated
   */
  BROWSER getBrowser();
  ...
  /**
   * Sets the value of the '{@link fr.imta.tp.selenium.selenium.Close#getBrowser <em>Browser</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
