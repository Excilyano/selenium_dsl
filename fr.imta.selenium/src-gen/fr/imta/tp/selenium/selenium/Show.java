 ...
 * <ul>
 *   <li>{@link fr.imta.tp.selenium.selenium.Show#getElem <em>Elem</em>}</li>
 *   <li>{@link fr.imta.tp.selenium.selenium.Show#getArrayAccess <em>Array Access</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.imta.tp.selenium.selenium.SeleniumPackage#getShow()
 * @model
 * @generated
 */
public interface Show extends CallNative
{
  /**
   ...
   * @see fr.imta.tp.selenium.selenium.SeleniumPackage#getShow_Elem()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link fr.imta.tp.selenium.selenium.Show#getElem <em>Elem</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.imta.tp.selenium.selenium.SeleniumPackage#getShow_ArrayAccess()
  ...
  /**
   * Sets the value of the '{@link fr.imta.tp.selenium.selenium.Show#getArrayAccess <em>Array Access</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
